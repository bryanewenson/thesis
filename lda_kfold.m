function [EC_avg, avg_test_acc, avg_train_acc, CV, DCV] = lda_kfold(features, labels, validation_runs, K)
...
%   Detailed explanation goes here
    ...
    for v = 1:validation_runs
        ...
        for g = 1:K
            ...
            group_train_pred = predict(model, training_set);
            ...
            group_test_pred = predict(model, testing_set);
